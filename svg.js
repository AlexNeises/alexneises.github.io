(function() {
	var badAngleDeltaCount, colorTable, cvsContainer, drawPolygon, height, i, mouseElement, mouseEvent, mouseMove, polygons, radians, renderNexrad, renders, shadeColor, strokeTable, totalRenderTime, width, zoomScale;
	...
	cvsContainer = d3.select('body').append('canvas').attr('width', width).attr('height', height).call(d3.zoom().scaleExtent([1, 25]).on('zoom', function() {
		cvsContainer.save();
